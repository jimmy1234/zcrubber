...
@implementation WheelXRotateLayer
...
-(void) initWithWheelId:(NSString *)wheelId {
    ...
    backgroundImage = [CCSprite spriteWithFile:[wheelId stringByAppendingFormat: @"_zm_0000.png"]];
    CGSize screenSize = [[CCDirector sharedDirector]winSize];
    [backgroundImage setPosition:CGPointMake(screenSize.width/2, 100)];
...
-(void) ccTouchMoved:(UITouch *)touch withEvent:(UIEvent *)event {
    ...
    NSString *str = nil;
    if(imgIndex < 10) {
        str = [wheelId stringByAppendingFormat: @"_zm_000%d.png", imgIndex];
    } else str = [wheelId stringByAppendingFormat: @"_zm_00%d.png", imgIndex];
